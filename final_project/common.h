 ...
 * Critical Variables
 *******************/
#define SPLICE_DELAY 5000 //time between calculating splice ratios
#define SPLICE_FRAME 100  //controls resolution of splice ratio from servers
#define SPLICE_THRESH 30  //TODO threshold of change needed to send update
...
#define BUF_LOST_THRSH 50  // missing packets older than seq=(newest seq)-LOST_THRSH are considered as lost 
